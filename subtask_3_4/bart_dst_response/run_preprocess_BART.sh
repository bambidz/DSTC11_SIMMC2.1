...
cat "${PATH_DIR}"/data/simmc2.1_dials_dstc11_dev_predict.txt >> "${PATH_DIR}"/data/simmc2.1_dials_dstc11_train_predict.txt
cat "${PATH_DIR}"/data/simmc2.1_dials_dstc11_dev_target.txt >> "${PATH_DIR}"/data/simmc2.1_dials_dstc11_train_target.txt